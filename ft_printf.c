...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/09 14:15:49 by relvan            #+#    #+#             */
/*   Updated: 2023/08/09 14:48:46 by relvan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_checkformat(va_list args, const char format)
{
	...
	else if (format == 'p')
	{
		...
		print_length += ft_print_unsignednbr(va_arg(args, unsigned int));
...
int	ft_printf(const char *str, ...)
{
	...
	while (str[i])
	{
		if (str[i] == '%')
		{
			print_length += ft_checkformat(args, str[i + 1]);
			i++;
		}
		else
